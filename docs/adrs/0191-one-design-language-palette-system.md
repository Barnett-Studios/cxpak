...
# ADR-0191: One design language + a client-side palette system
...
3. *One design language ("Blueprint") + a palette picker.* The VS Code / Obsidian model: identity carried by structure/typography/the proof-tick motif (ADR-0193), color carried by a swappable token set.
