...
# ADR-0176: Repo-DNA genome-barcode signature
...
**Consequences.** A compact, deterministic, animatable fingerprint reusable in three surfaces. Requires the DNA render to obey the fixed-point coordinate rule (ADR-0177) so it stays byte-stable cross-platform.
