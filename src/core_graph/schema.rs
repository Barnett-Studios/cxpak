//! Schema data model: the `SchemaIndex` and its sub-structs.
//!
//! Pure data types only — the detection/extraction/linking logic that builds
//! these from the codebase stays in `src/schema/` (it orchestrates over the
//! index and parser output).
